...
$riwayat = $conn->query("
  SELECT b.nama_pasien, d.nama AS nama_dokter, r.keluhan, r.resep, b.tanggal, b.waktu
  FROM rekam_medis r
...
<head>
  <meta charset="UTF-8">
  <title>Riwayat Konsultasi - Klinik-ku</title>
...
<section class="hero">
  <div class="container">
    ...
    <p class="text-muted">Riwayat pemeriksaan dan resep Anda di Klinik-ku</p>
  </div>
</section>
      ...
      <table class="table table-bordered align-middle">
        ...
        <tbody>
          <?php if ($riwayat->num_rows > 0): $no = 1; ?>
            ...
            <?php endwhile; ?>
          <?php else: ?>
            <tr><td colspan="7" class="text-center text-muted">Belum ada riwayat konsultasi.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
